...
@section('content')
    <div class="col-md-6 col-md-offset-3">
        <form class="form-horizontal" method="post" action="/auth/register/hospital">
            <fieldset>
                ...
                <!-- Form Name -->
                <legend class="text-center">Register as a Hospital</legend>

                <!-- Text input http://getbootstrap.com/css/#forms -->
                <div class="form-group">
                    <label for="id" class="control-label col-sm-2">ID</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="id" placeholder="Hospital ID" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="textinput" placeholder="Hospital Name" required="">
